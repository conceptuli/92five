...
@section('head')
<title>Wynkk Project Management - My Monthly Project Report</title>
@stop
@section('content')
  ...
  <div class="main_content">
    <div class="row-fluid">
      <div class="span12 project_detail">
        <div class="monthly_title">MonthlyReport for {{$name}} generated on {{App::make('date')}} for the Project {{$data['projectName']}}</div>
